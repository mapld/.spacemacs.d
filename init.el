...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(git-auto-commit-mode ensime sbt-mode groovy-mode irony company-irony flycheck-irony flycheck-pos-tip)
